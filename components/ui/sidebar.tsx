      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground no-close-button"
            style={
              {
          ...
          >
            ...
            <div className="flex h-full w-full flex-col overflow-y-auto custom-scrollbar">{children}</div>
          </SheetContent>
        </Sheet>
      )
    }
    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow custom-scrollbar"
          >
            {children}
          </div>
        </div>
